...
---------------------------------------------------------------
GRANT ROLE FIN_CUSTOMER_SYSADMIN_FR TO ROLE IDENTIFIER($dnaSysAdmin);
GRANT ROLE HR_PEOPLE_SYSADMIN_FR TO ROLE IDENTIFIER($dnaSysAdmin);
GRANT ROLE MKT_SLS_SYSADMIN_FR TO ROLE IDENTIFIER($dnaSysAdmin);
...
GRANT ROLE FIN_CUSTOMER_SYSADMIN_FR TO ROLE IDENTIFIER($mgtSysAdmin);
GRANT ROLE HR_PEOPLE_SYSADMIN_FR TO ROLE IDENTIFIER($mgtSysAdmin);
GRANT ROLE MKT_SLS_SYSADMIN_FR TO ROLE IDENTIFIER($mgtSysAdmin);
...
---------------------------------------------------------------
GRANT ROLE FIN_CUSTOMER_CUST360_FULL_AR TO ROLE IDENTIFIER($dnaEngC);
GRANT ROLE HR_PEOPLE_EMP_FULL_AR TO ROLE IDENTIFIER($dnaEngC);
GRANT ROLE MKT_SLS_INVOICES_FULL_AR TO ROLE IDENTIFIER($dnaEngC);
...
---------------------------------------------------------------
GRANT ROLE FIN_CUSTOMER_CUST360_R_AR TO ROLE IDENTIFIER($dnaAnaR) ;
GRANT ROLE HR_PEOPLE_EMP_R_AR TO ROLE IDENTIFIER($dnaAnaR);
GRANT ROLE MKT_SLS_INVOICES_R_AR TO ROLE IDENTIFIER($dnaAnaR);
